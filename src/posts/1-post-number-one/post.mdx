...
<GatsbyImage image={getImage(props.embeddedImages[0])} all='random satff' className='first-inline-img' />

<GatsbyImage image={getImage(props.embeddedImages[1])} all='random satff' className='first-inline-img' />
